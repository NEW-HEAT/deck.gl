...
/** Project a lng/lat to absolute Web Mercator common space. */
...
/**
 * Return a projection-invariant Mercator viewport for geospatial bounds math.
 * GlobeView's live common space is sphere cartesian, but terrain covers are
 * rendered and sampled in Mercator common space.
 */
